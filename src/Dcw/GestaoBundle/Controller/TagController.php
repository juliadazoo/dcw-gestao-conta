...
use Dcw\GestaoBundle\Entity\Tag;
use Dcw\GestaoBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DcwGestaoBundle:Tag')->findAll();

        return $this->render('DcwGestaoBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DcwGestaoBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DcwGestaoBundle:Tag')->find($id);
        ...
        return $this->render('DcwGestaoBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DcwGestaoBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
